...
impl WalletService {
    ...
    pub async fn create_dispute_case(
        ...
        Ok(DisputeInfoResponse {
            ...
            buyer_created_at: BsonDateTime::now().to_rfc3339_string(),
            seller_action: None,
            seller_response: None,
            seller_evidence_images: vec![],
            seller_updates_count: 0,
            seller_offer_amount: None,
            seller_deadline: BsonDateTime::now().to_rfc3339_string(),
            buyer_deadline: None,
            escalated_at: None,
            escalated_by: None,
            exchange_count: 0,
            ...
            created_at: BsonDateTime::now().to_rfc3339_string(),
            updated_at: BsonDateTime::now().to_rfc3339_string(),
        })
    }
    ...
    fn convert_dispute_to_response(&self, dispute: &DisputeCase) -> DisputeInfoResponse {
        DisputeInfoResponse {
            ...
            buyer_created_at: dispute.buyer_created_at.to_rfc3339_string(),
            ...
            seller_deadline: dispute.seller_deadline.to_rfc3339_string(),
            buyer_deadline: dispute.buyer_deadline.as_ref().map(|d| d.to_rfc3339_string()),
            escalated_at: dispute.escalated_at.as_ref().map(|d| d.to_rfc3339_string()),
            ...
            created_at: dispute.created_at.to_rfc3339_string(),
            updated_at: dispute.updated_at.to_rfc3339_string(),
        }
    }
